	...
	?>
		<td>
			<table border="0" style="width:100%;">
            	<tr><td width=50% align="center" valign="middle"><font size="+3"><a class="a1" href="<?=$row["href"]?>"><?=$row["city_name"]?></a></font></td><td width=50%><a class="a1" href="<?=$row["city_href"]?>"><img src="<?=$row["city_image"]?>" height="250" width="300" /></a></td></tr>
            </table>
	<?
		if($cnt == 2)
		{
