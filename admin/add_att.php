...
<body bgcolor="#000000">
<form name="frmproduct" method="post" action="add_att1.php" enctype="multipart/form-data">
<br><br><br><br><br><br><br><br>
    <table border="1" align="center" bgcolor="#FFFFFF" bordercolor="#CC9900" width="50%" height="50%">
    	<tr>
        	<td align="right"  class="k1">Catagory Name : </td>
            <td><input type="text" name="txtattnm" required/></td>
        </tr>
        <tr>
        	<td align="right" class="k1">Catagory Image : </td>
            <td><input type="file" name="attimg"/></td>
        </tr>
        <tr>
